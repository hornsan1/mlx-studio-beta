...
| Pruning recommendation | Existing Expert Lab hit/mass heuristic; specialized REAP; JANG `recommend` conversion profile | Strategy candidate generation plus measured evaluation | Preserve provenance; never combine raw scores; require structural and evaluation gates |
