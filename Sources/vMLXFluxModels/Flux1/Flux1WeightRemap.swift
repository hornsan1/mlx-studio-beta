...
public enum Flux1WeightRemap {
    ...
    public static func remapKey(_ key: String) -> String {
        ...
        let topLevel: [(String, String)] = [
            ...
            ("x_embedder.weight",                         "imgIn.weight"),
            ("x_embedder.bias",                           "imgIn.bias"),
            ("time_in.in_layer.weight",                   "timeIn0.weight"),
            ("time_in.in_layer.bias",                     "timeIn0.bias"),
            ("time_text_embed.timestep_embedder.linear_1.weight", "timeIn0.weight"),
            ("time_text_embed.timestep_embedder.linear_1.bias",   "timeIn0.bias"),
            ("time_in.out_layer.weight",                  "timeIn2.weight"),
            ("time_in.out_layer.bias",                    "timeIn2.bias"),
            ("time_text_embed.timestep_embedder.linear_2.weight", "timeIn2.weight"),
            ("time_text_embed.timestep_embedder.linear_2.bias",   "timeIn2.bias"),
            ("vector_in.in_layer.weight",                 "vectorIn0.weight"),
            ("vector_in.in_layer.bias",                   "vectorIn0.bias"),
            ("time_text_embed.text_embedder.linear_1.weight", "vectorIn0.weight"),
            ("time_text_embed.text_embedder.linear_1.bias",   "vectorIn0.bias"),
            ("vector_in.out_layer.weight",                "vectorIn2.weight"),
            ("vector_in.out_layer.bias",                  "vectorIn2.bias"),
            ("time_text_embed.text_embedder.linear_2.weight", "vectorIn2.weight"),
            ("time_text_embed.text_embedder.linear_2.bias",   "vectorIn2.bias"),
            ("guidance_in.in_layer.weight",               "guidanceIn0.weight"),
            ("guidance_in.in_layer.bias",                 "guidanceIn0.bias"),
            ("time_text_embed.guidance_embedder.linear_1.weight", "guidanceIn0.weight"),
            ("time_text_embed.guidance_embedder.linear_1.bias",   "guidanceIn0.bias"),
            ("guidance_in.out_layer.weight",              "guidanceIn2.weight"),
            ("guidance_in.out_layer.bias",                "guidanceIn2.bias"),
            ("time_text_embed.guidance_embedder.linear_2.weight", "guidanceIn2.weight"),
            ("time_text_embed.guidance_embedder.linear_2.bias",   "guidanceIn2.bias"),
            ("txt_in.weight",                             "txtIn.weight"),
            ("txt_in.bias",                               "txtIn.bias"),
            ("context_embedder.weight",                    "txtIn.weight"),
            ("context_embedder.bias",                      "txtIn.bias"),
            ("final_layer.linear.weight",                 "finalLayer.linear.weight"),
            ("final_layer.linear.bias",                   "finalLayer.linear.bias"),
            ("proj_out.weight",                           "finalLayer.linear.weight"),
            ("proj_out.bias",                             "finalLayer.linear.bias"),
            ...
            ("norm_out.linear.weight",                    "finalLayer.mod.weight"),
            ("norm_out.linear.bias",                      "finalLayer.mod.bias"),
        ]
    ...
    private static func remapDoubleBlockKey(_ k: String) -> String? {
        ...
        let leafTable: [(String, String)] = [
            ...
            ("norm1.linear.weight",                         "imgMod.linear.weight"),
            ("norm1.linear.bias",                           "imgMod.linear.bias"),
            // img attention
            ("img_attn.qkv.weight",                         "imgAttnQKV.weight"),
            ("img_attn.qkv.bias",                           "imgAttnQKV.bias"),
            ("attn.to_q.weight",                            "imgAttnQKV.weight"),
            ("attn.to_q.bias",                              "imgAttnQKV.bias"),
            ("attn.to_k.weight",                            "imgAttnQKV.weight"),
            ("attn.to_k.bias",                              "imgAttnQKV.bias"),
            ("attn.to_v.weight",                            "imgAttnQKV.weight"),
            ("attn.to_v.bias",                              "imgAttnQKV.bias"),
            ("img_attn.proj.weight",                        "imgAttnProj.weight"),
            ("img_attn.proj.bias",                          "imgAttnProj.bias"),
            ("attn.to_out.0.weight",                        "imgAttnProj.weight"),
            ("attn.to_out.0.bias",                          "imgAttnProj.bias"),
            ("img_attn.norm.query_norm.scale",              "imgAttnNorm.qNorm.weight"),
            ("img_attn.norm.key_norm.scale",                "imgAttnNorm.kNorm.weight"),
            ("attn.norm_q.weight",                          "imgAttnNorm.qNorm.weight"),
            ("attn.norm_k.weight",                          "imgAttnNorm.kNorm.weight"),
            // img mlp
            ("img_mlp.0.weight",                            "imgMlp0.weight"),
            ("img_mlp.0.bias",                              "imgMlp0.bias"),
            ("ff.linear1.weight",                           "imgMlp0.weight"),
            ("ff.linear1.bias",                             "imgMlp0.bias"),
            ("img_mlp.2.weight",                            "imgMlp2.weight"),
            ("img_mlp.2.bias",                              "imgMlp2.bias"),
            ("ff.linear2.weight",                           "imgMlp2.weight"),
            ("ff.linear2.bias",                             "imgMlp2.bias"),
            // txt modulation
            ("txt_mod.lin.weight",                          "txtMod.linear.weight"),
            ("txt_mod.lin.bias",                            "txtMod.linear.bias"),
            ("norm1_context.linear.weight",                 "txtMod.linear.weight"),
            ("norm1_context.linear.bias",                   "txtMod.linear.bias"),
            // txt attention
            ("txt_attn.qkv.weight",                         "txtAttnQKV.weight"),
            ("txt_attn.qkv.bias",                           "txtAttnQKV.bias"),
            ("attn.add_q_proj.weight",                      "txtAttnQKV.weight"),
            ("attn.add_q_proj.bias",                        "txtAttnQKV.bias"),
            ("attn.add_k_proj.weight",                      "txtAttnQKV.weight"),
            ("attn.add_k_proj.bias",                        "txtAttnQKV.bias"),
            ("attn.add_v_proj.weight",                      "txtAttnQKV.weight"),
            ("attn.add_v_proj.bias",                        "txtAttnQKV.bias"),
            ("txt_attn.proj.weight",                        "txtAttnProj.weight"),
            ("txt_attn.proj.bias",                          "txtAttnProj.bias"),
            ("attn.to_add_out.weight",                      "txtAttnProj.weight"),
            ("attn.to_add_out.bias",                        "txtAttnProj.bias"),
            ("txt_attn.norm.query_norm.scale",              "txtAttnNorm.qNorm.weight"),
            ("txt_attn.norm.key_norm.scale",                "txtAttnNorm.kNorm.weight"),
            ("attn.norm_added_q.weight",                    "txtAttnNorm.qNorm.weight"),
            ("attn.norm_added_k.weight",                    "txtAttnNorm.kNorm.weight"),
            // txt mlp
            ("txt_mlp.0.weight",                            "txtMlp0.weight"),
            ("txt_mlp.0.bias",                              "txtMlp0.bias"),
            ("ff_context.linear1.weight",                   "txtMlp0.weight"),
            ("ff_context.linear1.bias",                     "txtMlp0.bias"),
            ("txt_mlp.2.weight",                            "txtMlp2.weight"),
            ("txt_mlp.2.bias",                              "txtMlp2.bias"),
            ("ff_context.linear2.weight",                   "txtMlp2.weight"),
            ("ff_context.linear2.bias",                     "txtMlp2.bias"),
        ]
    ...
    private static func remapSingleBlockKey(_ k: String) -> String? {
        ...
        let leafTable: [(String, String)] = [
            ...
            ("norm.linear.weight",                          "mod.linear.weight"),
            ("norm.linear.bias",                            "mod.linear.bias"),
            ("linear1.weight",                              "linear1.weight"),
            ("linear1.bias",                                "linear1.bias"),
            ("attn.to_q.weight",                            "linear1.weight"),
            ("attn.to_q.bias",                              "linear1.bias"),
            ("attn.to_k.weight",                            "linear1.weight"),
            ("attn.to_k.bias",                              "linear1.bias"),
            ("attn.to_v.weight",                            "linear1.weight"),
            ("attn.to_v.bias",                              "linear1.bias"),
            ("proj_mlp.weight",                             "linear1.weight"),
            ("proj_mlp.bias",                               "linear1.bias"),
            ...
            ("attn.norm_q.weight",                          "qkNorm.qNorm.weight"),
            ("attn.norm_k.weight",                          "qkNorm.kNorm.weight"),
        ]
        for (from, to) in leafTable where rest == from {
