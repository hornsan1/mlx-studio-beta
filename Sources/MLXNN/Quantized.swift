...
open class QuantizedEmbedding: Embedding, Quantized {
    ...
    convenience public init(
        ...
        let weight = MLXNNRandomInit.normal([embeddingCount, dimensions], scale: scale)
    ...
    /// Initializer meant for loaders that already have packed quantized
    /// weights and matching scale/bias tensors.
    public init(
...
open class QuantizedLinear: Linear, Quantized {
    ...
    public convenience init(
        ...
        let weight = MLXNNRandomInit.uniform(
