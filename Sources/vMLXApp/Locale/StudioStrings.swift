...
public extension L10n {
    ...
    enum Studio {
        ...
        static let context = L10nEntry(en: "Context", ja: "コンテキスト", ko: "컨텍스트", zh: "上下文")
        static let contextControls = L10nEntry(en: "Context controls", ja: "コンテキスト制御", ko: "컨텍스트 제어", zh: "上下文控制")
        static let contextLimit = L10nEntry(en: "Context limit", ja: "コンテキスト上限", ko: "컨텍스트 한도", zh: "上下文限制")
        ...
        static let decode = L10nEntry(en: "Decode", ja: "デコード", ko: "디코드", zh: "解码")
        ...
        static let finalUsage = L10nEntry(en: "Final usage", ja: "最終使用量", ko: "최종 사용량", zh: "最终用量")
        ...
        static let livePartial = L10nEntry(en: "Live partial", ja: "ライブ途中", ko: "실시간 일부", zh: "实时部分")
        ...
        static let lastPartial = L10nEntry(en: "Last partial", ja: "前回の途中値", ko: "마지막 일부", zh: "上次部分")
        static let maxResponse = L10nEntry(en: "Max response", ja: "最大応答", ko: "최대 응답", zh: "最大响应")
        ...
        static let noStreamMetricsYet = L10nEntry(en: "No stream metrics yet", ja: "ストリーム指標はまだありません", ko: "아직 스트림 지표 없음", zh: "暂无流式指标")
        static let noUsageYet = L10nEntry(en: "No usage yet", ja: "使用量はまだありません", ko: "아직 사용량 없음", zh: "暂无用量")
        ...
        static let output = L10nEntry(en: "Output", ja: "出力", ko: "출력", zh: "输出")
        static let outputCap = L10nEntry(en: "Output cap", ja: "出力上限", ko: "출력 상한", zh: "输出上限")
        ...
        static let prefill = L10nEntry(en: "Prefill", ja: "プリフィル", ko: "프리필", zh: "预填充")
        static let promptCeiling = L10nEntry(en: "Prompt ceiling", ja: "プロンプト上限", ko: "프롬프트 상한", zh: "提示词上限")
        ...
        static let speed = L10nEntry(en: "Speed", ja: "速度", ko: "속도", zh: "速度")
        ...
        static let systemPrompt = L10nEntry(en: "System prompt", ja: "システムプロンプト", ko: "시스템 프롬프트", zh: "系统提示词")
        static let total = L10nEntry(en: "Total", ja: "合計", ko: "합계", zh: "总计")
        static let ttft = L10nEntry(en: "TTFT", ja: "TTFT", ko: "TTFT", zh: "TTFT")
        ...
        static let cachedTokensFormat = L10nEntry(en: "%@ cached", ja: "%@ キャッシュ済み", ko: "%@ 캐시됨", zh: "%@ 已缓存")
