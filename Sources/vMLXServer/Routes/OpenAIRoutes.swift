...
public enum OpenAIRoutes {
    ...
    static func mapEngineError(_ err: EngineError) -> Response {
        ...
        case .metalRuntimeUnavailable:
            // Image generation preflight failed before model load or
            // generation. 503 is a better signal than 500: the request is
            // structurally valid, but the local Metal runtime is not ready.
            return errorJSON(.serviceUnavailable, err.description)
