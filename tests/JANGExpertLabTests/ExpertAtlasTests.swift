// Moved from hornsan1/jangq-private@5d5487c27fa81d9f51da27264ae855964e334070
// jang-runtime/Tests/JANGExpertLabTests/ExpertAtlasTests.swift.
import XCTest
import CoreGraphics
import SQLite3
...
final class ExpertAtlasTests: XCTestCase {
    ...
    func testMaskValidationBlocksTooFewAvailableExpertsAndWarnsHotDrops() {
        let mask = ExpertMask(layers: [0: [0, 1, 2]])
    ...
    func testArtifactWriterPersistsTraceSuiteAtlasAndGenerations() throws {
        ...
        let runtimeInfo = ExpertModelRuntimeInfo(
            backend: "jangtq",
