...
final class DomainContractTests: XCTestCase {
    ...
    func testCoreContractsAreSendable() {
        ...
        requireSendable(OptimizationWorkspaceRequest.self)
        requireSendable(OptimizationWorkspaceEvent.self)
        requireSendable(OptimizationWorkerJobSnapshot.self)
        ...
        requireSendable(MAESTROExpertEvidence.self)
        requireSendable(StrategyRecoveryUsage.self)
        requireSendable(StrategyRetentionEvidence.self)
