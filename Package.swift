...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "MLXStudioEvaluation",
            dependencies: ["MLXStudioDomain", "MLXStudioPersistence"],
            path: "Sources/MLXStudioEvaluation",
            swiftSettings: [
                .enableExperimentalFeature("StrictConcurrency")
            ]
        ),
        ...
        .testTarget(
            name: "MLXStudioEvaluationTests",
            dependencies: [
                "MLXStudioDomain",
                "MLXStudioPersistence",
                "MLXStudioEvaluation",
            ],
            path: "tests/MLXStudioEvaluationTests"
        ),
        .testTarget(
            name: "JANGExpertLabTests",
            dependencies: [
                "JANGExpertLab",
                "MLXStudioDomain",
            ],
        ...
        .testTarget(
            ...
            // This v2 tag checkout carries a compact tests/vMLXTests
            // directory. Keep the SwiftPM target aligned to the files
            // present here so app-product builds do not emit missing-source
            // warnings before they reach the MLX Studio targets.
            sources: [
                ...
                "HuggingFaceDownloadSafetyTests.swift",
                "HuggingFaceRuntimeCompatibilityTests.swift",
                "HuggingFaceSearchHydrationTests.swift",
                "ImageGenerationSafetyTests.swift",
